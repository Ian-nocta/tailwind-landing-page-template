      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="pt-12 md:pt-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-16">
            ...
            <p className="text-xl text-gray-600">Coeus AI is a cutting-edge consulting startup specializing in helping enterprises harness the potential of AI technology.</p>
          </div>
          ...
          <div className="md:grid md:grid-cols-12 md:gap-6">
            ...
            <div className="max-w-xl md:max-w-none md:w-full mx-auto md:col-span-7 lg:col-span-6 md:mt-6" data-aos="fade-right">
              <div className="md:pr-4 lg:pr-12 xl:pr-16 mb-8">
                ...
                <p className="text-xl text-gray-600">With a comprehensive range of tools, Coeus AI aims to empower businesses by providing detailed product comparisons for IT solutions.</p>
              </div>
              {/* Tabs buttons */}
