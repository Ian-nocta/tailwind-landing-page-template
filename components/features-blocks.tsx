      ...
      <div className="relative max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          ...
          <div className="max-w-3xl mx-auto text-center pb-12 md:pb-20">
            ...
            <p className="text-xl text-gray-600">With a comprehensive range of solutions, Coeus AI aims to empower businesses by providing detailed product comparisons for IT solutions like cloud computing services, project management tools, and CRM software.</p>
          </div>
